...
export const studioOnboardSchema = z.object({
  ...
  // Step 6: Equipment — photography / videography
  ...
  video_monitor:    z.boolean().default(false),
  // Step 6: Equipment — podcast / audio
  condenser_mic:    z.boolean().default(false),
  dynamic_mic:      z.boolean().default(false),
  broadcast_mic:    z.boolean().default(false),
  pop_filter:       z.boolean().default(false),
  podcast_mixer:    z.boolean().default(false),
  headphone_amp:    z.boolean().default(false),
  acoustic_treatment: z.boolean().default(false),
  // Step 6: Equipment — music recording
  studio_monitors:  z.boolean().default(false),
  mixing_console:   z.boolean().default(false),
  daw_computer:     z.boolean().default(false),
  isolation_booth:  z.boolean().default(false),
  di_box:           z.boolean().default(false),
  instrument_amps:  z.boolean().default(false),
